...
impl From<shitspeak_proto::mumble_proto::RequestBlob> for RequestBlob {
    fn from(proto: shitspeak_proto::mumble_proto::RequestBlob) -> Self {
        Self {
...
impl From<RequestBlob> for shitspeak_proto::mumble_proto::RequestBlob {
    fn from(value: RequestBlob) -> Self {
        shitspeak_proto::mumble_proto::RequestBlob {
