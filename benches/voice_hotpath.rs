...
//!
//! `SHITSPEAK_BENCH_REPORT=1` runs the shared startup cost-model calibration,
//! then checks its decisions against independent partition sweeps. That report
//! includes spawn_blocking, encryption, and merging, plus elapsed calibration
//! and full-report times.
...
fn run_fanout_report() {
    ...
    let report = runtime
        ...
        .expect("voice dispatch calibration");
    print!("{report}");
    println!(
